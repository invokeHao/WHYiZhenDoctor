...
- (void) setupButtons{
    ...
    [cancelButton setFrame:CGRectMake(0, 0, 40, 17)];
    ...
    [backBtn setFrame:CGRectMake(0, 0, 30, 22)];
    [backBtn addTarget:self action:@selector(backToLibray) forControlEvents:UIControlEventTouchUpInside];
